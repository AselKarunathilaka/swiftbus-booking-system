...
export function validateName(name) {
  // Regex: Only allows uppercase/lowercase letters and spaces, minimum 2 characters.
...
export async function signupUser({email, password, name, phone}, errorEl) {
  ...
  if(!validateName(name)) throw new Error("Name is too short or contains invalid characters.");
